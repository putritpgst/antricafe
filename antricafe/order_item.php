    ...
    <div class="card-body">
      ...
      <div>
        <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-success"; ?>"
          data-bs-toggle="modal" data-bs-target="#tambahItem"><i class="bi bi-plus-square"></i> Tambah Item</button>
        <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary disabled" : "btn btn-primary"; ?>"
          ...
          Bayar</button>
        <button onclick="printStruck()" class="btn btn-info">Cetak Struk</button>
      </div>
    </div>
  </div>
</div>
...
<div id="strukContent" class="d-none">
  ...
  <div id="struk">
    <h2>Struk Pembayaran Antri Cafe</h2>
